  ...
  return (
    <View className="flex-1 bg-white">
      ...
      {currentIndex === onboardImages.length - 1 ? (
        ...
        <View className=" items-center justify-center px-4 pb-8">
          <TouchableOpacity
            className="w-full flex-row items-center justify-center gap-2 rounded-lg bg-cor-primaria px-[24px] py-[12px]"
