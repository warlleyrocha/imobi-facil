...
export default function ImageSlide({
  ...
  return (
    <View className="w-full gap-4">
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={{ width: screenWidth }} className="items-center justify-center">
            ...
            <Text className="pb-[6px] pt-[50px] text-center font-inter-semibold text-[24px] text-[#111928] md:text-4xl">
              {item.title}
            </Text>
            <Text className="px-4 text-center font-inter-light text-[14px] text-[#6B7280] md:text-lg">
              {item.description}
            </Text>
          </View>
        )}
      ...
      <View className="mt-[20px] flex-row items-center justify-center gap-[5px]">
